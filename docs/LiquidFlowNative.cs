...
public class Program
{
    public static void Main()
    {
        ...
        int ret = LiquidFlowDetector.DetectFromFile(
            @"E:\01wk\vs2026\opencv-pro\image\test.jpg",
            @"C:\temp\grayImage.png",
        ...
        if (result.Success == 1)
        {
            ...
            Console.WriteLine($"  BestAngle = {result.BestAngle:F2} deg");
            Console.WriteLine($"  BestIdx1  = {result.BestIdx1:F1}");
            Console.WriteLine($"  BestIdx2  = {result.BestIdx2:F1}");
            Console.WriteLine($"  grayImage 已保存至: C:\\temp\\grayImage.png");
        }
        else
        {
